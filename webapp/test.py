...
class TestFunctions(unittest.TestCase):
    ...
    def setUp(self):
        self.line_to_insert = ["2017-05-12T23:37:30Z","c702be7d","gateway","offline"]
    ...
    def test_fetch_top_from_day(self):
        self.assertEqual(self.fetcher.fetch_top_from_day("2017-05-01T00:17:50Z")[0]["_id"], "a4a281ad")

    @fill_collection_and_init_fetcher
    def test_get_percentage_change_from_last_week(self):
        self.assertEqual(self.fetcher.get_percentage_change_from_last_week("a4a281ad", "2017-05-08T23:58:40Z", 9), "200.0%")

    @fill_collection_and_init_fetcher
    def test_get_devices_per_day(self):
        self.assertEqual(self.fetcher.get_devices_per_day("2017-05-01T01:06:30Z", "online", "gateway"), 2)

    @fill_collection_and_init_fetcher
    def test_fetch_available_types_and_statuses(self):
        self.assertEqual(self.fetcher.fetch_available_types_and_statuses(), {'statuses': ['offline', 'online'], 'types': ['gateway', 'sensor']})
